...
지금까지 SLO가 무엇인지 살펴봤습니다. 인터넷에서 서비스를 제공하는 조직이라면 잘 알고 관리해야 할 개념일 것 같은데요, 그렇다면 여기서 SRE 이야기를 한 번 해봐야 할 것 같습니다. 왜냐하면 이러한 목표를 좀 더 전문적으로 관리하는 조직이 존재하거든요. 큰 IT 기업의 채용 공고에서 종종 볼 수 있는 조직명이기도 합니다.

...
* 전체 번역: http://arahansa.github.io/docs_spring/jpa.html
* 쿼리 메소드 작성법: http://docs.spring.io/spring-data/jpa/docs/current/reference/html/#jpa.query-methods.query-creation
* 다른 메뉴얼
  * https://ultrakain.gitbooks.io/jpa/content/chapter12/chapter12.4.html
  * https://slipp.net/wiki/display/SLS/JPA

...
http://blog.woniper.net/231
 ...
 - tmux, centos 6.5 에서 1.6 이하 버젼 말고 최신으로 깔기 (2.0)
  ...
  => libevent를 별도의 디렉토리에 설치하고자 할 때: ./configure CFLAGS="-I$DIR/include" LDFLAGS="-L$DIR/lib" (http://unix.stackexchange.com/questions/17907/why-cant-gcc-find-libevent-when-building-tmux-from-source)

...
14. 새로 배운 리눅스 명령어
 ...
 - grep 의 마법
  ...
  => 여러개 검색어 검색: grep 'word1\|word2\|word3' /location/file (egrep 은 'word1|word2|word3' 라고만 해도 된다)
...
21. shell 프로그래밍
 ...
 - $# == 인자 수, $1 == 첫번째 인자 (입력 문장에서 두번째 컬럼), $0 == 파일명 (입력문장에서 첫번째 컬럼)
